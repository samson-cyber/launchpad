...
- **The authoritative record of what shipped is the ANNOTATED GIT TAGS**, never the markers and never the manifest. `git tag` returns `v1.0.5`, `v2.0.0`, `v2.1.0` and nothing else. A marker tells you which arc a commit belonged to; a tag tells you a user can install it.
